...
init_path = os.path.join('kore_plugins_sanic', '__init__.py')
...
entry_points = """\
[kore.components]
kore.components.sanic =\
    kore_plugins_sanic.plugins.application:SanicApplicationPluginComponent
"""


setup(
    name='kore-plugins-sanic',
    version=metadata['version'],
    author=metadata['author'],
    author_email=metadata['email'],
    url=metadata['url'],
    packages=find_packages(include=('kore_plugins_sanic*',)),
